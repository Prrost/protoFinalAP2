...
const (
	...
	BookService_AdjustQuantity_FullMethodName = "/book.BookService/AdjustQuantity"
)
...
func (c *bookServiceClient) AdjustQuantity(ctx context.Context, in *AdjustQuantityRequest, opts ...grpc.CallOption) (*AdjustQuantityResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdjustQuantityResponse)
	err := c.cc.Invoke(ctx, BookService_AdjustQuantity_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedBookServiceServer) AdjustQuantity(context.Context, *AdjustQuantityRequest) (*AdjustQuantityResponse, error) {
...
func _BookService_AdjustQuantity_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdjustQuantityRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(BookServiceServer).AdjustQuantity(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: BookService_AdjustQuantity_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BookServiceServer).AdjustQuantity(ctx, req.(*AdjustQuantityRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var BookService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _BookService_AdjustQuantity_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "book-service/book/book.proto",
}
