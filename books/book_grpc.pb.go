...
type BookServiceClient interface {
	ListBooks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*BookList, error)
...
func (c *bookServiceClient) ListBooks(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*BookList, error) {
...
type BookServiceServer interface {
	ListBooks(context.Context, *emptypb.Empty) (*BookList, error)
...
func (UnimplementedBookServiceServer) ListBooks(context.Context, *emptypb.Empty) (*BookList, error) {
